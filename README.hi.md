...
| [Market Efficiency](./examples/market-efficiency.md) | अर्थशास्त्र | Order vs Innovation, Competition vs Cooperation | Patterns Amplify Forces, Tradeoffs Are Inescapable |
...
| [`examples/`](./examples/) | 7 अतिरिक्त केस स्टडीज़ |
| [`templates/_core-template.md`](./templates/_core-template.md) | साझा 7-चरण कार्यप्रवाह कंकाल |
| [`templates/`](./templates/) | 5 डोमेन-विशिष्ट टेम्पलेट (एल्गोरिदम, AI एजेंट, NPC समाज, संगठन, प्रोटोकॉल) |
...
### v2.1 (योजनाबद्ध)
- [ ] इंटरैक्टिव वेब डेमो
- [ ] अतिरिक्त केस स्टडीज़ (वितरित सिस्टम, जैविक सिस्टम, अर्थशास्त्र)
- [ ] टेम्पलेट विस्तार (API डिज़ाइन, सर्वसम्मति प्रोटोकॉल, गेम डिज़ाइन)
- [ ] सामुदायिक-योगदानित तनाव और Invariant
- [ ] बहुभाषी समर्थन (चीनी, जापानी)
